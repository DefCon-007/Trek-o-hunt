...
class Conn(Singleton):
	...
	def get_connection():
		try:
			if not Conn._conn:
				if level == 'p':
					uri = "mongodb+srv://sblayush:1234@cluster0-iptk6.mongodb.net/test/test1"
				else:
...
def copy_data_to_local():
	...
	uri = "mongodb+srv://sblayush:1234@cluster0-iptk6.mongodb.net/test"
	...
	# print(json.dumps(orders_dict_main, indent=2))
	# print(json.dumps(items_dict_main, indent=2))
	# print(json.dumps(counters_dict_main, indent=2))
...
if __name__ == '__main__':
	...
	#
	#
	# print(len(orders_dict_main))
	# print(len(items_dict_main))
	# print(len(counters_dict_main))
	...
	# # client = pymongo.MongoClient("mongodb+srv://sblayush:1234@cluster0-iptk6.mongodb.net/test")
